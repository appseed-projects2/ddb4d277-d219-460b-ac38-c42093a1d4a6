...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-02-05 22:55`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/ddb4d277-d219-460b-ac38-c42093a1d4a6.git
$ cd ddb4d277-d219-460b-ac38-c42093a1d4a6
```
